...
export type NeteaseMailProviderKey = '163' | '126' | 'yeah'

export type NeteaseMailServerPreset = {
  key: NeteaseMailProviderKey
  domain: string
  label: string
  imap: {
    host: string
...
export type NeteaseMailCredential = {
  email: string
  authorizationCode: string
  providerPreset: NeteaseMailProviderKey
}
