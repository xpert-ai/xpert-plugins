...
import type { ConnectionPolicy } from '../lib/policy-input'
export type { ConnectionPolicy } from '../lib/policy-input'
            ...
            {objects
              ...
              .map((object) => (
                <label key={key(object)}>
                  ...
                  />
                  <span>{[object.database, object.schema, object.name].filter(Boolean).join('.')}</span>
                </label>
              ))}
          </div>
          <p>
