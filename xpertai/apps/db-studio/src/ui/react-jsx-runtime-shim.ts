...
const createElement: (type: ReactNamespace.ElementType, props: JsxProps) => ReactNamespace.ReactElement =
...
export const jsx: typeof ReactJsxRuntime.jsx = (type, props, key) => createElement(type, normalizeProps(props, key))
export const jsxs: typeof ReactJsxRuntime.jsxs = jsx
export const jsxDEV: typeof ReactJsxDevRuntime.jsxDEV = (type, props, key) =>
  createElement(type, normalizeProps(props, key))
