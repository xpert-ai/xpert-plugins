...
import type { PlanPayload } from '../lib/types.js'
...
export interface RecordPage<T = SavedRecord> {
  items: T[]
  page: number
  pageSize: number
  hasMore: boolean
}
export function mergeRecords<T extends { id: string }>(previous: T[], incoming: T[]): T[] {
