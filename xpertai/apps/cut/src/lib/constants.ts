...
export const CUT_TOOLSET_PROVIDER_KEY = 'cut'
...
export const CUT_DEFAULT_TRANSCRIPTION_MODE = 'sandbox_whisper' as const
...
export const CUT_RENDER_SANDBOX_ACTION_VERSION = '1.1.5'
export const CUT_TRANSCRIPTION_AUDIO_SANDBOX_ACTION = 'cut.prepare-transcription-audio'
export const CUT_TRANSCRIPTION_AUDIO_SANDBOX_ACTION_VERSION = '1.0.0'
export const CUT_TRANSCRIPTION_WHISPER_SANDBOX_ACTION = 'cut.transcribe-whisper'
export const CUT_TRANSCRIPTION_WHISPER_SANDBOX_ACTION_VERSION = '1.0.0'
export const CUT_TRANSCRIPTION_WHISPER_MODEL = 'Xenova/whisper-tiny'
