...
if (!packageJson.name || !packageJson.version) {
  throw new Error('Excalidraw package name and version are required.')
}
if (pluginManifest.name !== packageJson.name) {
  throw new Error('Excalidraw package and plugin manifest names must match.')
}
...
if (pluginManifest.version !== packageJson.version) {
  ...
  console.log(`Synchronized Excalidraw plugin manifest version to ${packageJson.version}.`)
}
