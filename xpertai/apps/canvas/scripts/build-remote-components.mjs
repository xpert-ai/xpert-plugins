...
const componentNames = ['canvas-workbench']
...
if (process.argv.includes('--check')) {
  ...
  await Promise.all(outputs.flatMap(({ outputPath, text, cssOutputPath, cssText }) => [writeFile(outputPath, text), writeFile(cssOutputPath, cssText)]))
}
