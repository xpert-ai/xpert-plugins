...
name: xyz-rise-big
description: |
  Rise Big — a composable AnimXYZ entrance via the xyz="fade up-5 big-25%" attribute. Declarative: mix
...
od:
  ...
  design_system:
    requires: false
  example_prompt: |
    Use AnimXYZ xyz="fade up-5 big-25%" on the element as a entrance; toggle xyz-in to play, with a
    prefers-reduced-motion fallback.
---

# XYZ · Rise Big

Rise Big — composable entrance from [AnimXYZ](https://animxyz.com) (MIT). Part of
...
## How to apply
1. Include @animxyz/core CSS. 2. Set xyz="fade up-5 big-25%" on the element. 3. Toggle class xyz-in / xyz-out.
