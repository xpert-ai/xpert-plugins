...
name: xyz-fade-left
description: |
  Fade Left — a composable AnimXYZ entrance via the xyz="fade left-3" attribute. Declarative: mix
...
od:
  ...
  design_system:
    requires: false
  example_prompt: |
    Use AnimXYZ xyz="fade left-3" on the element as a entrance; toggle xyz-in to play, with a
    prefers-reduced-motion fallback.
---

# XYZ · Fade Left

Fade Left — composable entrance from [AnimXYZ](https://animxyz.com) (MIT). Part of
...
## How to apply
1. Include @animxyz/core CSS. 2. Set xyz="fade left-3" on the element. 3. Toggle class xyz-in / xyz-out.
