...
name: xyz-fade-down
description: |
  Fade Down — a composable AnimXYZ entrance via the xyz="fade down-3" attribute. Declarative: mix
...
od:
  ...
  design_system:
    requires: false
  example_prompt: |
    Use AnimXYZ xyz="fade down-3" on the element as a entrance; toggle xyz-in to play, with a
