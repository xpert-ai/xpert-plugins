...
name: xyz-fade-right
description: |
  Fade Right — a composable AnimXYZ entrance via the xyz="fade right-3" attribute. Declarative: mix
...
od:
  ...
  design_system:
    requires: false
  example_prompt: |
    Use AnimXYZ xyz="fade right-3" on the element as a entrance; toggle xyz-in to play, with a
    prefers-reduced-motion fallback.
---

# XYZ · Fade Right

Fade Right — composable entrance from [AnimXYZ](https://animxyz.com) (MIT). Part of
...
## How to apply
1. Include @animxyz/core CSS. 2. Set xyz="fade right-3" on the element. 3. Toggle class xyz-in / xyz-out.
