...
triggers: ["strands","shader background","webgl background","着色器背景","动态背景"]
...
## How to apply
Copy `_fx/shaderbg.js` + `strands.js`; add `<div class="strands" style="position:absolute;inset:0"></div>` behind content.
