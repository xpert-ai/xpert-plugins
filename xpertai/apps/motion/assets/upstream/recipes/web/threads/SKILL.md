...
triggers: ["threads","shader background","webgl background","着色器背景","动态背景"]
...
## How to apply
Copy `_fx/shaderbg.js` + `threads.js`; add `<div class="threads" style="position:absolute;inset:0"></div>` behind content.
