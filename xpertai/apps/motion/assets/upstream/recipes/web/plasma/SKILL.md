...
triggers: ["plasma","shader background","webgl background","着色器背景","动态背景"]
...
## How to apply
Copy `_fx/shaderbg.js` + `plasma.js`; add `<div class="plasma" style="position:absolute;inset:0"></div>` behind content.
