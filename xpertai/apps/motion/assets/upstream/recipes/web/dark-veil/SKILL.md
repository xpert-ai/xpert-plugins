...
triggers: ["dark-veil","shader background","webgl background","着色器背景","动态背景"]
...
## How to apply
Copy `_fx/shaderbg.js` + `dark-veil.js`; add `<div class="dark-veil" style="position:absolute;inset:0"></div>` behind content.
