...
triggers: ["ferrofluid","shader background","webgl background","着色器背景","动态背景"]
...
## How to apply
Copy `_fx/shaderbg.js` + `ferrofluid.js`; add `<div class="ferrofluid" style="position:absolute;inset:0"></div>` behind content.
