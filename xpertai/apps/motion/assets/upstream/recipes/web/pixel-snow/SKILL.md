...
triggers: ["pixel-snow","shader background","webgl background","着色器背景","动态背景"]
...
## How to apply
Copy `_fx/shaderbg.js` + `pixel-snow.js`; add `<div class="pixel-snow" style="position:absolute;inset:0"></div>` behind content.
