...
triggers: ["ripple-grid","shader background","webgl background","着色器背景","动态背景"]
...
## How to apply
Copy `_fx/shaderbg.js` + `ripple-grid.js`; add `<div class="ripple-grid" style="position:absolute;inset:0"></div>` behind content.
