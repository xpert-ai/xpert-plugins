...
triggers: ["line-waves","shader background","webgl background","着色器背景","动态背景"]
...
## How to apply
Copy `_fx/shaderbg.js` + `line-waves.js`; add `<div class="line-waves" style="position:absolute;inset:0"></div>` behind content.
