...
triggers: ["liquid-chrome","shader background","webgl background","着色器背景","动态背景"]
...
## How to apply
Copy `_fx/shaderbg.js` + `liquid-chrome.js`; add `<div class="liquid-chrome" style="position:absolute;inset:0"></div>` behind content.
