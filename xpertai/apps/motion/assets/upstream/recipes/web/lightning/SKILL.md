...
triggers: ["lightning","shader background","webgl background","着色器背景","动态背景"]
...
## How to apply
Copy `_fx/shaderbg.js` + `lightning.js`; add `<div class="lightning" style="position:absolute;inset:0"></div>` behind content.
