---
name: anim-jackinthebox
description: |
  Jack In The Box — a drop-in CSS keyframe animation from Animate.css (Hippocratic-2.1, © Daniel Eden).
...
od:
  ...
  design_system:
    requires: false
  example_prompt: |
    Apply jackInTheBox (Animate.css) to the element as a entrance animation, restrained, with a
