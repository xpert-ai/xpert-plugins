---
name: anim-zoomoutright
description: |
  Zoom Out Right — a drop-in CSS keyframe animation from Animate.css (Hippocratic-2.1, © Daniel Eden).
...
od:
  ...
  design_system:
    requires: false
  example_prompt: |
    Apply zoomOutRight (Animate.css) to the element as a exit animation, restrained, with a
