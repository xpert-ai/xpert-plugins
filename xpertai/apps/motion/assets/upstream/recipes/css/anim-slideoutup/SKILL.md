---
name: anim-slideoutup
description: |
  Slide Out Up — a drop-in CSS keyframe animation from Animate.css (Hippocratic-2.1, © Daniel Eden).
...
od:
  ...
  design_system:
    requires: false
  example_prompt: |
    Apply slideOutUp (Animate.css) to the element as a exit animation, restrained, with a
