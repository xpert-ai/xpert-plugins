...
name: fx-data-stream
description: |
  Streaming data lines — a flowing techy backdrop. A bold, canvas-based effect from Open Design's html-ppt fx pack — for slides and launch
...
od:
  ...
  design_system:
    requires: false
  example_prompt: |
    Use fx-data-stream as a background effect on a slide or hero: call HPX['data-stream'](el) on a positioned dark
    container; keep to one bold effect per screen, with a reduced-motion guard.
---

# Data Stream

Streaming data lines — a flowing techy backdrop. From [Open Design](https://github.com/nexu-io/open-design)'s html-ppt fx pack (Apache-2.0).
