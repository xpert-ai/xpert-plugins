...
description: |
  Multi-line typewriter — types lines in sequence. A bold, canvas-based effect from Open Design's html-ppt fx pack — for slides and launch
...
od:
  ...
  design_system:
    requires: false
  example_prompt: |
    Use fx-typewriter-multi as a text effect on a slide or hero: call HPX['typewriter-multi'](el) on a positioned dark
