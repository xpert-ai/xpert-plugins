...
name: bottom-sheet
description: |
  A bottom sheet slides up over a dimmed backdrop, then dismisses. An App-UI micro-interaction (mobile component feedback). Honors prefers-reduced-motion.
...
od:
  ...
  design_system:
    requires: false
  example_prompt: |
    Use bottom-sheet on the section: a quick, native-feeling micro-interaction with a
