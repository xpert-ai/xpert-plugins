...
export const STORY_START_RENDER_TOOL_NAME = 'story_start_render'
export const STORY_GET_RENDER_TOOL_NAME = 'story_get_render'
export const STORY_WAIT_RENDER_TOOL_NAME = 'story_wait_render'
...
export const STORY_RENDER_QUEUE_NAME = 'story-studio.render'
export const STORY_RENDER_JOB_NAME = 'storyboard-production'
export const STORY_RENDER_SANDBOX_ACTION = 'story-studio.storyboard-render'
export const STORY_RENDER_SANDBOX_ACTION_VERSION = '1.1.0'
