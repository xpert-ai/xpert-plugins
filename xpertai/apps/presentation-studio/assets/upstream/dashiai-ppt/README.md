...
- `theme13` 深蓝光环风 (86 页): 适配场景: 科技汇报、产品发布、技术复盘; 适配人群: 技术团队、产品负责人、企业管理者
- `theme14` 紫橙怪趣风 (82 页): 适配场景: 节日活动、创意课堂、娱乐故事; 适配人群: 活动策划者、教师、创意内容团队
...
新增主题复用既有主题模块，并通过共享 ESM runtime graph 按需链接；不会为 `theme13`、`theme14` 各自保存重复的自包含运行时。
