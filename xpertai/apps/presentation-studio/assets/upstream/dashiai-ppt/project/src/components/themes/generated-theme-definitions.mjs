...
export const GENERATED_THEME_RECIPES = {
  theme13:{"pageCount":86,"sources":["theme11","theme01","theme05","theme09"],"familyWeights":{"cover":12,"table":11,"metrics":12,"comparison":10,"timeline":9,"general":8,"media":11,"statement":8}},
  theme14:{"pageCount":84,"sources":["theme09","theme07","theme05","theme01"],"familyWeights":{"cover":12,"metrics":11,"general":9,"timeline":10,"ranking":9,"media":11,"comparison":10,"statement":8}},
  // @new-theme:recipe
};
