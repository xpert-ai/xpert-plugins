...
export function serializePage(page) {
  ...
  const serialized = {
    ...
    slot: page.slot,
    label: page.label,
    sourceTheme: page.sourceTheme || undefined,
    sourcePageKey: page.sourcePageKey || undefined,
    moduleFamily: page.moduleFamily || undefined,
    moduleOrigin: page.moduleOrigin || undefined,
    moduleStrategy: page.moduleStrategy || undefined,
    archetypeId: page.archetypeId || undefined,
    evidenceMode: page.evidenceMode || undefined,
    evidenceRefs: page.evidenceRefs || undefined,
    derivedFromRules: page.derivedFromRules || undefined,
    anchorModuleRefs: page.anchorModuleRefs || undefined,
    stylePrimitiveRefs: page.stylePrimitiveRefs || undefined,
    derivationReason: page.derivationReason || undefined,
    styleSignals: page.styleSignals || undefined,
    sourceContract: page.sourceContract || undefined,
