...
import { IDocumentUnderstandingProvider } from '@xpert-ai/contracts'
...
type PaddleOcrDocument = Parameters<IImageUnderstandingStrategy<PaddleOCRConfig>['understandImages']>[0]
