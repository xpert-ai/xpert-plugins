...
const plugin: XpertPlugin<z.infer<typeof ConfigSchema>> = {
  meta: {
    ...
    displayName: 'MinerU Document Converter',
    description: 'Parse PDF and supported documents with MinerU official or self-hosted services',
    keywords: ['integration', 'document', 'pdf', 'ocr', 'markdown', 'json', 'transformer'],
    author: 'XpertAI Team',
