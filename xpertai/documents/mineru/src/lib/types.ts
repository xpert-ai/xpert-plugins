import { ChunkMetadata, TDocumentAsset, TDocumentTransformerConfig } from "@xpert-ai/plugin-sdk"
...
export type MinerUChunkMetadata = {
...
export type MinerUDocumentMetadata = ChunkMetadata & {
  parser: 'mineru';
  assets?: TDocumentAsset[];
  taskId: string;
  taskIds?: string[];
  batches?: MinerUBatchTrace[];
  sourcePageCount?: number;
  originPdfUrl?: string;
