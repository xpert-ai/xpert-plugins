...
This Product Design entrypoint routes Product Design requests; it does not satisfy focused workflows itself.
...
Use this as the root routing guidance for Product Design plugin work. If several focused skills apply, sequence them in the order that creates the most useful design workflow. Keep this Product Design entrypoint as a router; do not perform focused workflow logic here.
