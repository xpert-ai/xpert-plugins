...
@Index('plugin_wecom_conversation_binding_tenant_org_idx', ['tenantId', 'organizationId'])
export class WeComConversationBindingEntity {
  static readonly tableName = 'plugin_wecom_conversation_binding'
