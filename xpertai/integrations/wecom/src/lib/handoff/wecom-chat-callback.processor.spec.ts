...
describe('WeComChatStreamCallbackProcessor', () => {
  ...
  it('throttles live stream updates to the latest content every two seconds', async () => {
    jest.useFakeTimers()
    ...
    try {
      ...
      expect(wecomChannel.sendReplyStreamByIntegrationId).toHaveBeenCalledTimes(1)
