import type { ITenant, TChatConversationStatus, TIntegrationProvider, TWorkflowTriggerMeta } from '@xpert-ai/contracts'
...
export const LARK_APP_CREDENTIALS_HELP_URL =
  'https://open.feishu.cn/document/home/introduction-to-custom-app-development/self-built-application-development-process'
export const LARK_APP_CREDENTIALS_HELP_LABEL = {
  en_US: 'Get App ID',
  zh_Hans: '获取App ID'
} as const
export const LARK_CONFIGURATION_GUIDE_HELP_URL =
  'https://docs.xpertai.cn/zh-Hans/ai/plugin/integration/lark-integration'
export const LARK_CONFIGURATION_GUIDE_HELP_LABEL = {
  en_US: 'Configuration Guide',
  zh_Hans: '配置手册'
} as const
export const LARK_INTEGRATION_HELP_LINKS = [
  {
    url: LARK_CONFIGURATION_GUIDE_HELP_URL,
    label: LARK_CONFIGURATION_GUIDE_HELP_LABEL
  },
  {
    url: LARK_APP_CREDENTIALS_HELP_URL,
    label: LARK_APP_CREDENTIALS_HELP_LABEL
  }
]

export type TLarkIntegrationProvider = TIntegrationProvider & {
  setup?: TIntegrationProvider['setup'] & { qrAuthorization?: boolean }
  helpLabel?: typeof LARK_APP_CREDENTIALS_HELP_LABEL
  helpLinks?: typeof LARK_INTEGRATION_HELP_LINKS
}

// Compatibility with published contracts preceding the host's generic QR setup support.
export type TLarkTriggerMeta = TWorkflowTriggerMeta & {
