...
- Absolute paths that still point to files inside the sandbox workspace root, such as `/workspace/sessions/thread/files/page-1.png`
- `workspace://` paths that resolve relative to the sandbox workspace root, such as `workspace://sessions/thread/files/page-1.png`
...
- Remote URLs or object storage paths
...
- pass all needed images in one call, for example `path: ["chart.png", "diagram.png"]` or `paths: ["chart.png", "diagram.png"]`
