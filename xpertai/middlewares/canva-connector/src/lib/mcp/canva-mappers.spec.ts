...
describe('Canva MCP response mappers', () => {
  ...
  it('bounds list and candidate responses', () => {
    const designs = mapDesignList(
      { items: Array.from({ length: 80 }, (_, index) => ({ id: `design-${index}` })) },
      1,
      50
    )
    const candidates = mapCandidateList({
      candidates: Array.from({ length: 30 }, (_, index) => ({ id: `candidate-${index}` }))
    })
      ...
      job: {
        ...
        result: {
          generated_designs: [
            {
              candidate_id: 'dg-1',
              url: 'https://www.canva.cn/design/dg-1',
              thumbnails: [{ url: 'https://www.canva.cn/thumb/dg-1' }]
            },
      ...
      items: [
        {
          ...
          title: null,
          description: null,
          openUrl: 'https://www.canva.cn/design/dg-1',
          hasPreview: true
        },
        ...
        job: {
          ...
          result: {
            design_compositions: [
              ...
              {
                url: 'https://attacker.example/design/three',
                thumbnail: { url: 'https://attacker.example/thumb/three' }
              }
            ]
          }
        }
      ...
      items: [
        {
          ...
          title: null,
          description: null,
          openUrl: 'https://www.canva.cn/design/one',
          hasPreview: true
        },
        {
          index: 2,
          ...
          title: null,
          description: null,
          openUrl: 'https://khsj.cn/short-two',
          hasPreview: true
        },
