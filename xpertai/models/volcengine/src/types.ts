...
export function toCredentialKwargs(credentials?: VolcengineModelCredentials) {
    ...
    const credentialsKwargs: OpenAIBaseInput = {
		apiKey: safeCredentials.ark_api_key,
	} as OpenAIBaseInput
	const configuration: ClientOptions = {}
	const openaiApiBase = (safeCredentials.api_endpoint_host || VolcengineBaseUrl).replace(/\/$/, '')
