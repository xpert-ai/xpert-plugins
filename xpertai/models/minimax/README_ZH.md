...
`@xpert-ai/plugin-minimax` 提供 MiniMax 的 LLM、TTS，使用官方 OpenAI 兼容 API（`https://api.minimaxi.com/v1`）。
...
- **LLM**: `MiniMax-M2.5`, `MiniMax-M2.5-highspeed`, `MiniMax-M2.1`, `MiniMax-M2.1-highspeed`, `MiniMax-M2`
