...
Migrate public registration to one decorated Cut provider, retaining MCP resources, prompts and tasks. Requires the SDK 3.19.0 decorated capability extensions.
