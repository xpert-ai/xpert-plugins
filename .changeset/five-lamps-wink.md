...
- document required callback and public base URL configuration
- align the plugin workspace with the published beta SDK dependency versions used for rollout
