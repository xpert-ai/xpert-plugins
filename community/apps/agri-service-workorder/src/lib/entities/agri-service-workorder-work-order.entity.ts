...
import type {
  ...
  AgriServiceSourceType,
  AgriServiceSupplementDraft,
  AgriServiceUrgency,
  AgriServiceWorkOrderStatus
} from '../types'
import type { AgriServiceWorkOrderLog } from './agri-service-workorder-work-order-log.entity'

@Entity('plugin_agri_service_workorder_work_order')
...
export class AgriServiceWorkOrder {
  ...
  @Column({ type: 'jsonb', nullable: true })
  aiSupplementDraft?: AgriServiceSupplementDraft | null
  ...
  @Column({ type: 'jsonb', nullable: true })
  similarWorkOrders?: AgriServiceSimilarWorkOrderSummary[]

  @Column({ type: 'timestamptz', nullable: true })
  processingStartedAt?: Date

  @Column({ type: 'varchar', nullable: true })
  processingResult?: AgriServiceProcessingResult
  ...
  @OneToMany('AgriServiceWorkOrderLog', (log: AgriServiceWorkOrderLog) => log.workOrder)
  logs?: AgriServiceWorkOrderLog[]
