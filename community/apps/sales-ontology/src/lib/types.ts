export type SalesOntologyRunType =
  | "perception"
  | "reasoning"
  | "insight"
  | "suggestion"
  ...
  | "learning"
  | "effect";
export type SalesOntologyRunStatus =
  | "pending"
  | "running"
  | "completed"
  | "failed";
export type SalesOntologySuggestionStatus =
  | "active"
  | "accepted"
  | "dismissed"
  | "converted";
export type SalesOntologyActionProposalStatus =
  | "pending"
  | "approved"
  | "rejected"
  | "executed"
