...
function prepareRequirementParseChatMessage(service: SupplierDueDiligenceService) {
...
function prepareSupplierQuoteParseMessages(service: SupplierDueDiligenceService) {
...
function createService(seed?: {
  ...
  const service = new SupplierDueDiligenceService(
...
describe('SupplierDueDiligenceService', () => {
