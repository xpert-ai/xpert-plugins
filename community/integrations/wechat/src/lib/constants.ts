...
export const WECHAT_LIST_CONVERSATIONS_TOOL_NAME = 'wechat_list_conversations'
export const WECHAT_SEARCH_MESSAGE_LOGS_TOOL_NAME = 'wechat_search_message_logs'
export const WECHAT_RESET_CONVERSATION_TOOL_NAME = 'wechat_reset_conversation'
export const WECHAT_REGISTER_CALLBACK_TOOL_NAME = 'wechat_register_callback'
