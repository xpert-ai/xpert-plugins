...
export const WECHAT_PERSONAL_ROTATE_WEBHOOK_CREDENTIAL_TOOL_NAME = 'wechat_personal_rotate_webhook_credential'
export const WECHAT_PERSONAL_REVOKE_WEBHOOK_CREDENTIAL_TOOL_NAME = 'wechat_personal_revoke_webhook_credential'
